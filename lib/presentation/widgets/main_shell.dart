...
IconData _iconForLabel(String label, {bool isActive = false}) {
  ...
  if (text.contains('category') || text.contains('categories') || text.contains('browse') || text.contains('menu')) return isActive ? Icons.grid_view_rounded : Icons.grid_view_outlined;
  if (text.contains('infant') || text.contains('kids') || text.contains('baby')) return isActive ? Icons.child_care_rounded : Icons.child_care_rounded;
  if (text.contains('clothing') || text.contains('bodysuit') || text.contains('wear')) return isActive ? Icons.checkroom_rounded : Icons.checkroom_rounded;
