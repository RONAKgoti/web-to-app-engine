...
class _MainShellState extends ConsumerState<MainShell> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      // NATIVE BOTTOM NAVIGATION BAR (Selective Hiding)
      bottomNavigationBar: (!isKeyboardVisible && navItems.length > 1 && !webState.hasNativeWebBar)
          ? Container(
              ...
              child: SafeArea(
                top: false, // Only bottom safety
                child: Container(
                  height: 64, // Standard Premium Height
