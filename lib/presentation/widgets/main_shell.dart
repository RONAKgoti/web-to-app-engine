...
class _MainShellState extends ConsumerState<MainShell> {
  ...
  Widget build(BuildContext context) {
    ...
    // 1. FIXED HOME BUTTON (ALWAYS INDEX 0)
    ...
    // 2. SCRAPED MENU ITEMS (DE-DUPLICATED)
    ...
    for (final webItem in displaySource) {
      ...
      if (labelRaw == 'home' || labelRaw == 'home page' || labelRaw == 'welcome') continue;
      if (usedNormalizedUrls.contains(itemNorm)) continue;
      if (itemNorm.isEmpty || itemNorm == 'ROOT' || itemNorm == '') continue;
  ...
  Widget _buildGlassFloatingBar(List<_NavItem> finalItems) {
    ...
    final double verticalMargin = bottomInset > 0 ? bottomInset + 8 : 24;
                  ...
                  child: InkWell(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        // Premium Dot Indicator (Minimal and Clean)
                        if (isActive)
                          Container(
