...
/// ─────────────────────────────────────────────────────────────
/// ULTRA-PREMIUM UNIVERSAL WEB-TO-APP SHELL (REPAIRED)
/// ─────────────────────────────────────────────────────────────
...
IconData _iconForLabel(String label) {
  ...
  if (text.contains('kid') || text.contains('child')) return Icons.child_care_outlined;
  if (text.contains('pay') || text.contains('wallet')) return Icons.account_balance_wallet_outlined;
