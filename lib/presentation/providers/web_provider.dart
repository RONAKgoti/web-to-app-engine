...
class WebNotifier extends StateNotifier<WebState> {
  ...
  int _priorityScore(String label) {
    ...
    if (l.contains('blog') || l.contains('article') || l.contains('news') || l.contains('resource')) return 200;
    if (l.contains('order') || l.contains('history') || l.contains('sale') || l.contains('offer') || l.contains('deal')) return 150;
    
    // Tier 4: Major Product Categories (Variety)
