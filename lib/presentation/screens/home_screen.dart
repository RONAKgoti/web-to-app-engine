    ...
    main!.querySelectorAll('img').forEach((img) {
      ...
      if (isLogo) {
        img.attributes['style'] =
            'height: 32px; width: auto; max-width: 150px; object-fit: contain; display: block; margin: 8px 0;';
      } else if (small) {
        img.attributes['style'] =
          ...
          if (!document.getElementById(SCRAPER_ID)) {
             ...
             const normalizeText = () => {
                document.querySelectorAll('h1, h2, h3, h4, h5, h6, div, span, p, a').forEach(el => {
                   ...
                   if (fs > 24) {
                      el.style.setProperty('font-size', 'clamp(18px, 6vw, 22px)', 'important');
