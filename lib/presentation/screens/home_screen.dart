    ...
    try {
      const script = r'''
        (() => {
          ...
          return JSON.stringify(allBestItems.slice(0, 20)); // Return more items for Dart to curate
        })();
      ''';
        ...
        (() => {
          ...
          if (!document.getElementById(SCRAPER_ID)) {
             ...
             css.innerHTML = `
               ...
               /* Premium Logo & Type Fix */
               img[src*="logo"], [class*="logo"] img, [id*="logo"] img, .navbar-brand img {
               ...
               h1, h2, h3 { line-height: 1.25 !important; margin: 0.5em 0 !important; }
