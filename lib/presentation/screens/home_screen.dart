...
class _HomeScreenState extends ConsumerState<HomeScreen> {
  ...
  Widget _buildAppDrawer(WebState state) {
    ...
    final remainingMenuItems = state.menuItems
        ...
        .toList();
    final drawerMenuItems = remainingMenuItems.isNotEmpty
        ? remainingMenuItems
        : (primaryItems.length <= 2 ? state.menuItems : const <WebItem>[]);
    final drawerSectionTitle =
        remainingMenuItems.isNotEmpty ? 'More pages' : 'Website sections';
