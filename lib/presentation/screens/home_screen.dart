...
class _HomeScreenState extends ConsumerState<HomeScreen> {
  ...
  Widget _buildAppDrawer(WebState state) {
    ...
    // In our new MainShell logic, they move to Drawer if website has enough categories
    final bottomBarPotentialTags = state.stableMenu.map((e) => e.label.toLowerCase()).toSet();
    final bool showAI = !bottomBarPotentialTags.contains('ai tools');
    final bool showHub = !bottomBarPotentialTags.contains('hub');
    final bool showProfile = !bottomBarPotentialTags.contains('profile');
            ...
            Expanded(
              child: ListView(
                ...
                children: [
                  ...
                  if (websiteMenuItems.isNotEmpty) ...[
                    const _DrawerSectionHeader(title: 'Website Directory'),
                    ...websiteMenuItems.map((item) => _DrawerPageTile(
