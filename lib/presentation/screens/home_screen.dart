    ...
    controller.setNavigationDelegate(
        NavigationDelegate(
          ...
          onPageStarted: (url) {
            ...
            _setLoading(true);
            _updateCurrentUrl(url);
            // INJECT INSTANT Hider CSS (to prevent double bars at the start)
            _controller?.runJavaScript(r'''
               (function() {
                 const style = document.createElement('style');
                 style.innerHTML = 'nav, footer, .bottom-nav, [class*="bottom-nav"], [class*="bottomNav"], [class*="MobileBottom"], [id*="bottom-nav"], [data-testid*="nav"] { display: none !important; visibility: hidden !important; opacity: 0 !important; height: 0 !important; pointer-events: none !important; }';
    ...
    try {
      const script = r'''
        (() => {
          ...
          const invalidLabelPattern = /read more|learn more|view more|click here|book now|download|watch now|apply now|buy now|see all|menu|back|next|previous|prev|close|help|support|contact|about|t&c|privacy|legal/i;
