...
class _HomeScreenState extends ConsumerState<HomeScreen> {
          ...
          onWebResourceError: (error) {
            ...
            setState(() {
              errorMessage = error.description.isNotEmpty
                  ? error.description
                  : 'This website could not be loaded inside the app.';
            });
          },
        ),
      );
  ...
  Future<void> _showToolsSheet() async {
    ...
    final extraItems = state.menuItems.length > 4
        ? state.menuItems.skip(4).toList()
        : const <WebItem>[];
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          actions: [
            ...
            IconButton(
              icon: const Icon(Icons.tune_rounded, color: Color(0xFF94A3B8), size: 22),
